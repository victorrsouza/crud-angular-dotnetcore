...
namespace iFood.Tests.UnitTests.Commands
{
    ...
    {
        private CreateProductCommand _sut;

        [SetUp]
        public void Setup()
        {
            _sut = Fixture.Create<CreateProductCommand>();
        }

        [Test]
        public void Create_product_command_id_is_required()
        {
            // Given
            _sut.Id = Guid.Empty;
        ...
        [Test]
        public void Create_product_command_name_is_required()
        {
            // Given
        ...
        [Test]
        public void Create_product_command_value_is_required()
        {
            // Given
            _sut.Value = 0;
        ...
        [TestCase(false, 256)]
        [TestCase(true, 257)]
        public void Create_product_command_name_max_limit(bool expectedResult, int stringLenght)
        {
            // Given
        ...
        public void Create_product_command_value_max_limit(bool expectedResult, decimal value)
        {
            // Given
            _sut.Value = value;
        ...
        [Test]
        public void Create_product_command_should_flow()
        {
            // When
            var validation = _sut.Validate();
